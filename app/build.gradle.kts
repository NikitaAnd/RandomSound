...
android { namespace = "com.nikita.randomsound"; compileSdk = 35
    defaultConfig { applicationId = "com.nikita.randomsound"; minSdk = 26; targetSdk = 35; versionCode = 1; versionName = "1.0" }
}
